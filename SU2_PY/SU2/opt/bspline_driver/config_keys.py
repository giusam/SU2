...
SUPPORTED_OPT_CONFIG_KEYS = {
    ...
    *THICKNESS_PROGRESSIVE_KEYS,
    ...
    "BSPLINE_SCORING_DIAGNOSTICS",
    "BSPLINE_SCORING_DIAGNOSTIC_DIR",
    "BSPLINE_SCORING_DIAGNOSTIC_NODAL_FIELDS",
    "BSPLINE_SCORING_DIAGNOSTIC_SVD",
    "BSPLINE_SCORING_DIAGNOSTIC_BASIS",
    "BSPLINE_SCORING_DIAGNOSTIC_IKKT",
