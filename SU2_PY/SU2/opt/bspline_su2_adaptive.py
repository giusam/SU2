...
def _build_arg_parser():
    ...
    parser.add_argument("--scoring-diagnostics", action="store_true", default=False)
    parser.add_argument("--no-scoring-diagnostics", dest="scoring_diagnostics", action="store_false")
    parser.add_argument("--scoring-diagnostic-dir", default="DIAGNOSTIC")
    parser.add_argument("--scoring-diagnostic-nodal-fields", action="store_true", default=True)
    parser.add_argument("--no-scoring-diagnostic-nodal-fields", dest="scoring_diagnostic_nodal_fields", action="store_false")
    parser.add_argument("--scoring-diagnostic-svd", action="store_true", default=True)
    parser.add_argument("--no-scoring-diagnostic-svd", dest="scoring_diagnostic_svd", action="store_false")
    parser.add_argument("--scoring-diagnostic-basis", action="store_true", default=True)
    parser.add_argument("--no-scoring-diagnostic-basis", dest="scoring_diagnostic_basis", action="store_false")
    parser.add_argument("--scoring-diagnostic-ikkt", action="store_true", default=True)
    parser.add_argument("--no-scoring-diagnostic-ikkt", dest="scoring_diagnostic_ikkt", action="store_false")
    parser.add_argument("--ikkt-include-geometry-constraints", action="store_true", default=None)
    parser.add_argument("--no-ikkt-include-geometry-constraints", dest="ikkt_include_geometry_constraints", action="store_false")
    parser.add_argument("--ikkt-include-aero-constraints", action="store_true", default=None)
    parser.add_argument("--no-ikkt-include-aero-constraints", dest="ikkt_include_aero_constraints", action="store_false")
    parser.add_argument("--ikkt-require-available-fields", action="store_true", default=None)
